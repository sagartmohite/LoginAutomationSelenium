...
//    }
    ...
    public void testInvalidLogin() throws InterruptedException
    {
        ...
        WebElement errorMessge = driver.findElement(By.className("notification-box-description"));
        // 3 seconds
        new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.visibilityOf(errorMessge));
    ...
    public void testValidLogin() throws InterruptedException {
        ...
        driver.manage().window().maximize();
        driver.get("https://app.vwo.com/#/login");
        driver.findElement(By.id("login-username")).sendKeys("kihove8187@coursora.com");
        driver.findElement(By.id("login-password")).sendKeys("KIHO@8187ve");
        //driver.findElement(By.id("js-login-btn")).click();
        Thread.sleep(5000);
